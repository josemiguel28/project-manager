                            ...
                            <div wire:key="week-{{ $week->id }}" class="relative flex items-center gap-4 py-4 pl-6 pr-5 transition-colors hover:bg-amber-50">
                                ...
                                <div class="shrink-0">
                                    <button
                                        ...
                                        class="inline-flex items-center rounded-md border border-slate-200 bg-white p-1.5 text-slate-400 transition-colors hover:border-rose-200 hover:bg-rose-50 hover:text-rose-500"
